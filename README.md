...
Note that I got the same key insight from the EDA using a python package called [ydata-profiling](https://github.com/SandyGCabanes/customer_churn_exploratory_data_analysis_ydata_profiling_python)<br>
